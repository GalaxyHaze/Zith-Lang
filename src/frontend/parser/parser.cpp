...
namespace zith::frontend::parser {
    ...
    bool Parser::expect(lexer::TokenKind kind) {
        (void)kind;
        return false;
    }
    ...
    ast::ExprId Parser::parseExpr(int) {
        return ast::kInvalidExpr;
    }
    ...
    ast::StmtId Parser::parseLetStmt() {
        return ast::kInvalidStmt;
    }
    ast::StmtId Parser::parseRetStmt() {
        return ast::kInvalidStmt;
    }
    ...
    int Parser::precedence(lexer::TokenKind) const {
        return 0;
    }
