...
int __imported_wasi_snapshot_preview1_clock_time_get(int a, long long b, int c) {
    return 0;
}
...
int __imported_wasi_snapshot_preview1_fd_write(int a, int b, int c, int d) {
    return 0;
}
...
void __imported_wasi_snapshot_preview1_proc_exit(int a) {
    while (1) {
    }
}
}
